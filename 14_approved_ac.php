    ...
    <div class="container">
      <div class="section-top-border">
        <form class="example" method="post">
          ...
          <div class="row">
            ...
            <div class="single-defination">
                <div>
                  ...
                  <input class="kuang" type="text" placeholder="Add.." name="add" value="">
                  <button class="genric-btn primary radius" type="submit" name="action" value="add">Add</button>
                </div>
            </div>
            </div>
          ...
          <div class="col-md-1">
          <div class="single-defination">
              <a href="14_approved_ac.php" class="genric-btn primary radius" float='left'>↻</a>
          </div>
          </div>
          <br><br><br><br>
          </div>
...
<?php } ?>
      ...
      <div class="single-defination">
        <br><br>
        <a href="8_admin_db.php" class="genric-btn primary radium">Back</a>
