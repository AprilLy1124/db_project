...
$sql = "SELECT I_Name, Item_Type FROM ITEM WHERE IsApproved=0;";
...
<?php } ?>
      ...
      <div class="single-defination">
          ...
          <button class="genric-btn default" type="submit" name="action" value="app_item"> Approve Selection </button>
      </div>
      </div>
      ...
      <div class="single-defination">
          ...
          <button class="genric-btn default" type="submit" name="action" value="del_item"> Delete Selection </button>
        </form>
      </div>
      </div>
